...
```python
>>> símbolos = 'AAPL,IBM,MSFT,YHOO,SCO'
>>>
```
...
>>> símbolos[2]
?
>>> símbolos[-1]        # Ultimo caracter
?
>>> símbolos[-2]        # Indices negativos son desde el final
?
>>>
```
...
Intenta realalizar la siguientes sentencias que concatenan a un nuevo símbolo "GOOG" al final de `símbolos`:


```python
>>> símbolos= símbolos + 'GOOG'
>>> símbolos
...
>>> símbolos[13:17]
?
>>> símbolos = símbolos.replace('SCO','DOA')
>>> símbolos
?
>>> nombre = '   IBM   \n'
...
```python
>>> texto= 'Hoy es 3/27/2018. Mañaña será 3/28/2018.'
